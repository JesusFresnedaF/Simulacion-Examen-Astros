...
public class SimulacionExamenAstros {
    ...
    private Planetas p[] = new Planetas[8];
    ...
    public void initPlanetas() {
        p[0] = new Planetas(57910000, 88.0f, false, "Mercurio", 2439.7f, 1408f, 3.3e23f, 440f, 1407.6f);

        p[1] = new Planetas(108200000, 224.7f, false, "Venus", 6051.8f, 5832.5f, 4.87e24f, 737f, 5832.4f);

        p[2] = new Planetas(149600000, 365.2f, true, "Tierra", 6378.1f, 23.93f, 5.97e24f, 288f, 9.81f);
        Satelites tierra1 = new Satelites(0.00257f, 0.00257f, "Tierra", "Luna", 1737.1f, 27.3f, 7.342e22f, 220.0f, 1.6f);
        p[2].addSatelite(tierra1);

        p[3] = new Planetas(227940000, 687.0f, true, "Marte", 3396.2f, 24.62f, 6.39e23f, 210f, 3.71f);
        ...
        p[3].addSatelite(marte1);
        p[3].addSatelite(marte2);

        p[4] = new Planetas(778330000, 4331.0f, true, "Jupiter", 71492f, 9.93f, 1.9e27f, 165f, 24.79f);
        ...
        p[4].addSatelite(jupiter1);
        p[4].addSatelite(jupiter2);
        p[4].addSatelite(jupiter3);
        p[4].addSatelite(jupiter4);

        p[5] = new Planetas(1429400000, 10747.0f, true, "Saturno", 60268f, 10.66f, 5.68e26f, 134f, 10.44f);
        ...
        p[5].addSatelite(sat1_saturno);
        p[5].addSatelite(sat2_saturno);
        p[5].addSatelite(sat3_saturno);

        p[6] = new Planetas(2870990000L, 30589.0f, true, "Urano", 25559f, 17.24f, 8.68e25f, 76f, 8.87f);
        ...
        p[6].addSatelite(sat1_urano);
        p[6].addSatelite(sat2_urano);
        p[6].addSatelite(sat3_urano);
        
        p[7] = new Planetas(4504300000L, 59800.0f, true, "Neptuno", 24764f, 16.11f, 1.02e26f, 72f, 11.15f);
        ...
        p[7].addSatelite(sat1_neptuno);
        p[7].addSatelite(sat2_neptuno);
        p[7].addSatelite(sat3_neptuno);
    ...
    private void menuPlaneta() {
        ...
        switch (op) {
            case 1 -> System.out.println("La masa de " + p[i].getNombre() + " es de: " + p[i].getMasa() + "kg.");
            case 2 -> System.out.println("El diametro de " + p[i].getNombre() + " es de " + p[i].getRadio_ecuatorial() * 2 + "km.");
            case 3 -> System.out.println("El periodo de rotacion sobre su eje es de: " + p[i].getRotacion_sobre_su_eje() + " horas.");
            case 4 -> System.out.println("El periodo de traslacion alrededor del cuerpo al que orbita es: " + p[i].getOrbita_al_sol() + " dias terrestres.");
            case 5 -> System.out.println("La distancia media al cuerpo al que orbitan es de: " + p[i].getDistancia_al_sol() + "km.");
            case 6 -> {
    ...
    private void mostrarPlanetas(){
        for (int i = 0; i < p.length; i++) {
            System.out.println(i+". "+p[i].getNombre());   
        }
    }
    ...
    private void menuSatelite() {
        ...
        int op = leerInt("Introduce una opcion (1-6): ");
        switch (op) {
            case 1 -> System.out.println("La masa de " + p[i].getSatelite(j).getNombre() + " es de: " + p[i].getSatelite(j).getMasa() + "kg.");
            case 2 -> System.out.println("El diametro de " + p[i].getSatelite(j).getNombre() + " es de " + p[i].getSatelite(j).getRadio_ecuatorial() * 2 + "km.");
            case 3 -> System.out.println("El periodo de rotacion sobre su eje es de: " + p[i].getSatelite(j).getRotacion_sobre_su_eje() + " días terrestres.");
            case 4 -> System.out.println("El periodo de traslacion alrededor del cuerpo al que orbita es: " + p[i].getSatelite(j).getOrbita_planetaria() + " dias.");
            case 5 -> System.out.println("La distancia media al cuerpo al que orbitan es de: " + p[i].getSatelite(j).getOrbita_planetaria() + "km.");
            case 6 -> {
                System.out.println("Fin del programa.");
                System.exit(0);
            }
    ...
    public void mostrarSatelites(int i){
        for (int j = 0; j < p[i].numSatelites(); j++) {
            System.out.println(j + ". " + p[i].getSatelite(j).getNombre());
        }
    }
